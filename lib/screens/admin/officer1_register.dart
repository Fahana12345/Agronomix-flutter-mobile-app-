...
class Officer1Register extends StatefulWidget {
  const Officer1Register({super.key});

  @override
  State<Officer1Register> createState() => _Officer1RegisterState();
}

class _Officer1RegisterState extends State<Officer1Register> {
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            ...
                            OfficerOneService _officerOneService=OfficerOneService();
                              ...
                              bool ? res= await    _officerOneService.signUp(officer);
                              if(res==true){
