...
import '../../models/cheif_officer_model.dart';
import '../../services/office_one_service.dart';


class ViewAllChiefOfficersScreen extends StatefulWidget {
  @override
  _ViewAllChiefOfficersScreenState createState() => _ViewAllChiefOfficersScreenState();
}

class _ViewAllChiefOfficersScreenState extends State<ViewAllChiefOfficersScreen> {
  ...
  Future<void> _loadOfficers() async {
    try {
      List<OfficerThreeModel> officers = await _officerThreeService.viewAllOfficers();
      setState(() {
        _officers = officers;
      });
    } catch (e) {
      ...
      body: Container(
        ...
        child:  _officers.length!=0? ListView.builder(
          ...
          itemBuilder: (context, index) {
            OfficerThreeModel officer = _officers[index] as OfficerThreeModel;
            return Card(
              child: ListTile(
                onTap: (){
