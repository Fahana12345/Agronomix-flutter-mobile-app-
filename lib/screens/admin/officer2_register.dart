...
class Officer2Register extends StatefulWidget {
  const Officer2Register({super.key});

  @override
  State<Officer2Register> createState() => _Officer2RegisterState();
}

class _Officer2RegisterState extends State<Officer2Register> {
                      ...
                      Center(
                        child: GestureDetector(
                          onTap: () async {
                           ...
                           OfficerTwoModel officer=OfficerTwoModel(
                              ...
                              bool ? res= await    _officertwoService.signUp(officer);
                              if(res==true){
